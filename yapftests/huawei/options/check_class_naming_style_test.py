    ...
    def __setup(self, name):
        style.SetGlobalStyle(
            style.CreateStyleFromConfig(
                ...
                f'check_class_naming_style: {name}}}'))

    def test_pascal_case(self):
        self.__setup('PascalCase')
        self.assertEqual(style.Get('CHECK_CLASS_NAMING_STYLE'), 'PASCALCASE')

    def test_camel_case(self):
        self.__setup('camelCase')
        self.assertEqual(style.Get('CHECK_CLASS_NAMING_STYLE'), 'CAMELCASE')

    def test_snake_case(self):
        self.__setup('snake_case')
        self.assertEqual(style.Get('CHECK_CLASS_NAMING_STYLE'), 'SNAKECASE')
